package tbz;// Get from Class library (JDK)

import java.util.Scanner;

/**
 * tbz.Input Methods like the BASIC INPUT (or c's scanf()).
 *
 * Because Java has no simple console input, I added this functions to
 * my library.
 * Simply import
 * <code>import static eu.gressly.io.utility.tbz.Input.*</code>
 * and then use
